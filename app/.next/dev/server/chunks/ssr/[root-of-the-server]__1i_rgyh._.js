...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sendTx$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/sendTx.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function CreateMarket() {
    ...
    const [resolutionDate, setResolutionDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(defaultDateTime);
    const [marketId, setMarketId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('1');
    ...
    const handleCreate = async ()=>{
        ...
        try {
            setLoading(true);
            setError('');
            const marketIdBN = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](Number(marketId));
            const resolutionTimeBN = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](resolutionTimestamp);
            const [marketPda] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PublicKey"].findProgramAddressSync([
                Buffer.from('market'),
                publicKey.toBuffer(),
                marketIdBN.toArrayLike(Buffer, 'le', 8)
            ], __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PROGRAM_ID"]);
            ...
            const { Transaction } = await __turbopack_context__.A("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-ssr] (ecmascript, async loader)");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sendTx$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendTx"])(new Transaction().add(ix), connection, publicKey, sendTransaction);
            router.push('/');
        } catch (e) {
            console.error(String(e));
            setError((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sendTx$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extractErrorMessage"])(e));
        } finally{
            setLoading(false);
        }
    };
...
"[project]/src/utils/sendTx.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1i_rgyh._.js.map